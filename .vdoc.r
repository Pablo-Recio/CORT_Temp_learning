...
ggsave("./output/figures/fig_deli.png", plot=fig_deli, width = 30, height = 20, units = "cm", dpi = 600)
...
ggsave("./output/figures/fig_guich.png", plot=fig_guich, width = 30, height = 20, units = "cm", dpi = 600)
...
formula <- (FC_associative ~ age.start + group*trial_associative + trial_associative*cort*temp + 
                            (1 + trial_associative|lizard_id) + (1|clutch) + (-1+group|obs))
...
#
summary(model_prel_deli)
summary(model_prel_guich)
#
#
#
#
