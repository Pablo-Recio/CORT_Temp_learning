...
#
#| label: fig-Methods
#| fig.cap: "Experimental design of the experiment. Panel A shows the early environment manipulation (see Methods). In panel B, the measurements of the 3D-printed ramps employed in the habituation and learning tasks. Panel C shows the habituation process with the three different stages. And in panel D, the associative task with the three different 3D printed ramps. White lids in D show the ramps where the food reward was not attainable."
