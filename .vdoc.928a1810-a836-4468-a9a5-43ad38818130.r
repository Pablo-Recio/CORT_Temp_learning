...
# Save the plot
tiff("figures/fig_spectrum.tiff", width = 25, height = 21, units = "cm", res = 600)
...
ggsave("./output/figures/fig_spectrum.png", plot= fig_spectrum, width = 25, height = 21, units = "cm", dpi = 600)
