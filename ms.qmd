...
For those individuals assigned to group 'Red', we did not find any significant differences between treatments neither for _L. delicata_ ('Control-Cold' - 'CORT-Cold' = `r format_dec(mean(dar_ControlCold - dar_CORTCold), 3)`, p- value = `r format_p(pmcmc(dar_ControlCold - dar_CORTCold), 3)`; 'Control-Hot' - 'CORT-Hot' = `r format_dec(mean(dar_ControlHot- dar_CORTHot), 3)`, p- value = `r format_p(pmcmc(dar_ControlHot - dar_CORTHot), 3)`; 'Control-Hot' - 'Control-Cold' = `r format_dec(mean(dar_ControlHot - dar_ControlCold), 3)`, p-value = `r format_p(pmcmc(dar_ControlHot - dar_ControlCold), 3)`; 'CORT-Hot' - 'CORT-Cold' = `r format_dec(mean(dar_CORTHot - dar_CORTCold), 3)`, p-value = `r format_p(pmcmc(dar_CORTHot - dar_CORTCold), 3)`) (see @fig-results), or _L. guichenoti_ ('Control-Cold' - 'CORT-Cold' = `r format_dec(mean(gar_ControlCold - gar_CORTCold), 3)`, p- value = `r format_p(pmcmc(gar_ControlCold - gar_CORTCold), 3)`; 'Control-Hot' - 'CORT-Hot' = `r format_dec(mean(gar_ControlHot- gar_CORTHot), 3)`, p- value = `r format_p(pmcmc(gar_ControlHot - gar_CORTHot), 3)`; 'Control-Hot' - 'Control-Cold' = `r format_dec(mean(gar_ControlHot - gar_ControlCold), 3)`, p-value = `r format_p(pmcmc(gar_ControlHot - gar_ControlCold), 3)`; 'CORT-Hot' - 'CORT-Cold' = `r format_dec(mean(gar_CORTHot - gar_CORTCold), 3)`, p-value = `r format_p(pmcmc(gar_CORTHot - gar_CORTCold), 3)`) (see @fig-results). However, in both species the slope in the 'CORTCold' treatments seems bigger than the rest for group 'Red'. When groups were pooled by incubation temperature, slopes from individuals incubated at 23ºC were on average bigger in both species, but the difference was not significant (_L. delicata_: 'Hot' learning slope - 'Cold' learning slope = `r format_dec(mean((dar_CORTHot + dar_ControlHot) - (dar_CORTCold + dar_ControlCold)),3)`, p-value = `r format_p(pmcmc((dar_CORTHot + dar_ControlHot) - (dar_CORTCold + dar_ControlCold)),3)`; _L. guichenoti_: 'Hot' learning slope - 'Cold' learning slope = `r format_dec(mean((gar_CORTHot + gar_ControlHot)-(gar_CORTCold + gar_ControlCold)),3)`, p-value = `r format_p(pmcmc((gar_CORTHot + gar_ControlHot)-(gar_CORTCold + gar_ControlCold)),3)`). CORT also lead to higher slopes in both species, but the differences were not significant (_L. delicata_: 'Control' learning slope - 'CORT' learning slope = `r format_dec(mean((dar_ControlCold + dar_ControlHot) - (dar_CORTCold + dar_CORTHot)), 3)`, p-value = `r format_p(pmcmc((dar_ControlCold + dar_ControlHot) - (dar_CORTCold + dar_CORTHot)), 3)` ; _L. guichenoti_: 'Control' learning slope - 'CORT' learning slope = `r format_dec(mean((gar_ControlCold + gar_ControlHot)-(gar_CORTCold + gar_CORTHot)), 3)`, p-value = `r format_p(pmcmc((gar_ControlCold + gar_ControlHot)-(gar_CORTCold + gar_CORTHot)), 3)`). We also did not find any significant differences when we compared the estimated slopes between species (_L. delicata_ - _L. guichenoti_ = `r format_dec(mean((dar_CORTCold + dar_ControlCold + dar_CORTHot + dar_ControlHot) - (gar_CORTCold + gar_ControlCold + gar_CORTHot + gar_ControlHot)), 3)`, p-value = `r format_p(pmcmc((dar_CORTCold + dar_ControlCold + dar_CORTHot + dar_ControlHot) - (gar_CORTCold + gar_ControlCold + gar_CORTHot + gar_ControlHot)), 3)`).  
...
The results for 'Blue' individuals were similar. We did not find significant differences between treatments in _L.delicata_ ('Control-Cold' - 'CORT-Cold' = `r format_dec(mean(dab_ControlCold - dab_CORTCold), 3)`, p- value = `r format_p(pmcmc(dab_ControlCold - dab_CORTCold), 3)`; 'Control-Hot' - 'CORT-Hot' = `r format_dec(mean(dab_ControlHot- dab_CORTHot), 3)`, p- value = `r format_p(pmcmc(dab_ControlHot - dab_CORTHot), 3)`; 'Control-Hot' - 'Control-Cold' = `r format_dec(mean(dab_ControlHot - dab_ControlCold), 3)`, p-value = `r format_p(pmcmc(dab_ControlHot - dab_ControlCold), 3)`; 'CORT-Hot' - 'CORT-Cold' = `r format_dec(mean(dab_CORTHot - dab_CORTCold), 3)`, p-value = `r format_p(pmcmc(dab_CORTHot - dab_CORTCold), 3)`) (see @fig-results), or _L. guichenoti_ ('Control-Cold' - 'CORT-Cold' = `r format_dec(mean(gab_ControlCold - gab_CORTCold), 3)`, p- value = `r format_p(pmcmc(gab_ControlCold - gab_CORTCold), 3)`; 'Control-Hot' - 'CORT-Hot' = `r format_dec(mean(gab_ControlHot- gab_CORTHot), 3)`, p- value = `r format_p(pmcmc(gab_ControlHot - gab_CORTHot), 3)`; 'Control-Hot' - 'Control-Cold' = `r format_dec(mean(gab_ControlHot - gab_ControlCold), 3)`, p-value = `r format_p(pmcmc(gab_ControlHot - gab_ControlCold), 3)`; 'CORT-Hot' - 'CORT-Cold' = `r format_dec(mean(gab_CORTHot - gab_CORTCold), 3)`, p-value = `r format_p(pmcmc(gab_CORTHot - gab_CORTCold), 3)`) (see @fig-results). However, here the estimated slopes from those incubated at higher temperatures seem to be bigger on average, although the difference was not significant (_L. delicata_: 'Hot' learning slope - 'Cold' learning slope = `r format_dec(mean((dab_CORTHot + dab_ControlHot) - (dab_CORTCold + dab_ControlCold)),3)`, p-value = `r format_p(pmcmc((dab_CORTHot + dab_ControlHot) - (dab_CORTCold + dab_ControlCold)),3)`; _L. guichenoti_: 'Hot' learning slope - 'Cold' learning slope = `r format_dec(mean((gab_CORTHot + gab_ControlHot)-(gab_CORTCold + gab_ControlCold)),3)`, p-value = `r format_p(pmcmc((gab_CORTHot + gab_ControlHot)-(gab_CORTCold + gab_ControlCold)),3)`). Also, 'Control' _L. delicata_ seem to have slightly higher estimated slopes than on average ('Control' learning slope - 'CORT' learning slope = `r format_dec(mean((dab_ControlCold + dab_ControlHot) - (dab_CORTCold + dab_CORTHot)), 3)`, p-value = `r format_p(pmcmc((dab_ControlCold + dab_ControlHot) - (dab_CORTCold + dab_CORTHot)), 3)` ) while in _L. guichenoti_ is the opposite ('Control' learning slope - 'CORT' learning slope = `r format_dec(mean((gab_ControlCold + gab_ControlHot)-(gab_CORTCold + gab_CORTHot)), 3)`, p-value = `r format_p(pmcmc((gab_ControlCold + gab_ControlHot)-(gab_CORTCold + gab_CORTHot)), 3)`); nevertheless, the differences found were not significant in any case. Finally, we found that learning slopes estimated for _L. guichenoti_ assigned to group 'Blue' were marginally higher than those from _L. delicata_ (_L. delicata_ - _L. guichenoti_ = `r format_dec(mean((dab_CORTCold + dab_ControlCold + dab_CORTHot + dab_ControlHot) - (gab_CORTCold + gab_ControlCold + gab_CORTHot + gab_ControlHot)), 3)`, p-value = `r format_p(pmcmc((dab_CORTCold + dab_ControlCold + dab_CORTHot + dab_ControlHot) - (gab_CORTCold + gab_ControlCold + gab_CORTHot + gab_ControlHot)), 3)`).  
...
On average, we found that, for both species, the proportion of correct choices in the first trial was significantly above chance when the correct feeder was blue (_L. delicata_: mean Prob choice = `r format_dec(mean((probright_dbCORTCold + probright_dbControlCold + probright_dbCORTHot + probright_dbControlHot)/4), 3)`, p-value = `r format_p(pmcmc(((probright_dbCORTCold + probright_dbControlCold + probright_dbCORTHot + probright_dbControlHot)/4), null = 0.33, twotail = FALSE, dir=">"), 3)`; _L. guichenoti_: mean Prob choice = `r format_dec(mean((probright_gbCORTCold + probright_gbControlCold + probright_gbCORTHot + probright_gbControlHot)/4), 3)`, p-value = `r format_p(pmcmc(((probright_gbCORTCold + probright_gbControlCold + probright_gbCORTHot + probright_gbControlHot)/4), null = 0.33, twotail = FALSE, dir=">"), 3)`), but not when it was red (_L. delicata_: mean Prob choice = `r format_dec(mean((probright_drCORTCold + probright_drControlCold + probright_drCORTHot + probright_drControlHot)/4), 3)`, p-value = `r format_p(pmcmc(((probright_drCORTCold + probright_drControlCold + probright_drCORTHot + probright_drControlHot)/4), null = 0.33, twotail = FALSE, dir=">"), 3)`; _L. guichenoti_: mean Prob choice = `r format_dec(mean((probright_drCORTCold + probright_drControlCold + probright_drCORTHot + probright_drControlHot)/4), 3)`, p-value = `r format_p(pmcmc(((probright_drCORTCold + probright_drControlCold + probright_drCORTHot + probright_drControlHot)/4), null = 0.33, twotail = FALSE, dir=">"), 3)`).  
