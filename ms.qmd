...
asso_mean <- format_dec(sapply(estimates_asso, mean), 4)
...
asso_pvalue <- format_dec(sapply(estimates_asso, pmcmc), 4)
#
rev_mean <- format_dec(sapply(estimates_rev, mean), 4)
...
rev_pvalue <- format_dec(sapply(estimates_rev, pmcmc), 4)
#
