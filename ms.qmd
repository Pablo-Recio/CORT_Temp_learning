...
To test if lizards were biased towards blue as our preliminary analyses indicated, we employed the intercept estimates from our posterior distribution to get the predicted probability of choosing the right in the first trial using the formula: 
