...
#
#| label: cleaning
source(here::here("R", "1_data_process.R"))
...
ggsave("./output/figures/dScomparisons.tif", plot= dScomparisons, width = 25, height = 18, units = "cm", dpi = 600)
knitr::include_graphics("./output/figures/dScomparisons.tif")
#
#
#
...
ggsave("./output/figures/dLcomparisons.tif", plot= dLcomparisons, width = 25, height = 18, units = "cm", dpi = 600)
knitr::include_graphics("./output/figures/dLcomparisons.tif")
#
#
#
cat("\\newpage")
...
ggsave("./output/figures/plot_age.tif", plot=plot_age, width = 25, height = 18, units = "cm", dpi = 600)
